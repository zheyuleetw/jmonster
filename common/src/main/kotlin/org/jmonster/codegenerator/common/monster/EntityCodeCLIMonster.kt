...
class EntityCodeCLIMonster(raw: Unit) : Monster<Unit, Unit>(raw) {
    ...
    override fun digestion(raw: Unit) {
        //TODO
    }
    ...
    private fun digestRawTable(dto: EntityCodeGenerateByTableRequestDto) {
    ...
    private fun digestPlainText(tableName: String, text: String, enversAudit: Boolean) {
        // [0] -> PK or UK or empty
        // [1] -> name
        // [2] -> type
        // [3] -> null or nonnull
